...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            ...
            "C:\\Users\\ADMINI~1\\AppData\\Local\\Temp\\pip-install-6h_znhj5\\gevent\\deps\\libev"
        ],
        "libraries": [
            "ws2_32"
        ],
...
static CYTHON_SMALL_CODE int __Pyx_InitCachedConstants(void) {
  ...
  __pyx_tuple__10 = PyTuple_Pack(1, __pyx_kp_s_Child_watchers_are_not_supported); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 1188, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
