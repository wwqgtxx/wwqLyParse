...
def test():
    ...
    # main("https://www.iqiyi.com/a_19rrhbhf6d.html", types="list")
    # main("https://www.iqiyi.com/a_19rrh8qrwl.html", types="list")
    main("http://www.iqiyi.com/v_19rrez6nc4.html", parsers_name=["IQiYiDashParser"])
    # main("http://www.iqiyi.com/v_19rrez6nc4.html", label="720P-H264-DASH-S@IQiYiDashParser")
    # main("http://www.iqiyi.com/v_19rrez6nc4.html", label="540P-H264-DASH-S@IQiYiDashParser")
    ...
    # main("http://www.le.com/ptv/vplay/25047584.html", label="HD@YKDLParser")
    # main("https://www.bilibili.com/video/av21877586", parsers_name=["AnnieParser"])
    # main("https://www.bilibili.com/video/av21877586", label="80@AnnieParser")
    ...
    # main("http://v.youku.com/v_show/id_XMjQ4MTc0ODMyOA==.html?spm=a2h1n.8251845.0.0", label="mp4hd3-guoyu@AnnieParser")
